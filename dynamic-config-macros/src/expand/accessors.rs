...
pub(super) fn remote_slot(is_generic: bool) -> TokenStream {
    slot(
        is_generic,
...
pub(super) fn aliases_slot(is_generic: bool) -> TokenStream {
    slot(
        is_generic,
...
pub(super) fn bindings_slot(is_generic: bool) -> TokenStream {
    slot(
        is_generic,
...
pub(super) fn flags_slot(is_generic: bool) -> TokenStream {
    slot(
        is_generic,
...
pub(super) fn overrides_slot(is_generic: bool) -> TokenStream {
    slot(
        is_generic,
...
pub(super) fn layer_setters() -> TokenStream {
    quote! {
...
pub(super) fn defaults_and_flag_setters() -> TokenStream {
    quote! {
        ...
        where
            __DynamicConfigDefaults: ::dynamic_config::__private::serde::Serialize,
        {
...
pub(super) fn binding_methods() -> TokenStream {
    quote! {
